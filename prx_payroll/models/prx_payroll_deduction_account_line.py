...
class PayrollDeductionAccountLine(models.Model):
    _name = 'prx.payroll.deduction.account.line'
    _description = 'Payroll Deduction Account Line'
    _check_company_auto = True

    deduction_id = fields.Many2one('prx.payroll.deduction', string='Deduction', required=True, ondelete='cascade')
